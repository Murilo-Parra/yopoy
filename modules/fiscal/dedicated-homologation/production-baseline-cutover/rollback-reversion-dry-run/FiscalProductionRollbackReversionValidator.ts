import { FiscalProductionBaselineRollbackInput } from './FiscalProductionBaselineRollbackTypes';

export class FiscalProductionRollbackReversionValidator {
  public static validate(input: FiscalProductionBaselineRollbackInput) {
    ...
    const kwToBlock = [
      ...
      'executerealrollback', 'executerealabort', 'revertrealtraffic', 'restorelegacybyruntime',
    ...
    const forceKeys = [
      'forceExecuteRealRollback', 'forceExecuteRealAbort', 'forceRevertRealTraffic', 'forceRestoreLegacyByRuntime',
