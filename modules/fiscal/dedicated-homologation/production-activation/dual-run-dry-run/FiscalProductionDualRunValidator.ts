import { FiscalProductionDualRunInput } from './FiscalProductionDualRunTypes';

export class FiscalProductionDualRunValidator {
  public static validate(input: FiscalProductionDualRunInput) {
    ...
    if (input.forceExecuteDualRun) blockers.push('forceExecuteDualRun blocked');
    if (input.forceDuplicateRealTraffic) blockers.push('forceDuplicateRealTraffic blocked');
    ...
    if (input.forceActivateCanary) blockers.push('forceActivateCanary blocked');
