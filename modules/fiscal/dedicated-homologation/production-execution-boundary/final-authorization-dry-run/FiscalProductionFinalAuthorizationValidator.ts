import { FiscalProductionFinalAuthorizationInput } from './FiscalProductionFinalAuthorizationTypes';

export class FiscalProductionFinalAuthorizationValidator {
  public static validate(input: FiscalProductionFinalAuthorizationInput) {
    ...
    const forceKeys = [
      'forceGrantRealAuthorization', 'forceUnlockRealGate', 'forceConcludeRealCommitteeApproval',
