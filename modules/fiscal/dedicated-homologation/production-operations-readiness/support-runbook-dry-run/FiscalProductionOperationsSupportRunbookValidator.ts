import { FiscalProductionOperationsSupportRunbookInput } from './FiscalProductionOperationsSupportRunbookTypes';

export class FiscalProductionOperationsSupportRunbookValidator {
  public static validate(input: FiscalProductionOperationsSupportRunbookInput) {
    ...
    const kwToBlock = [
      ...
      'openincident', 'createincident', 'executerunbook', 'runbookexecution', 'executemitigation',
      'executerollback', 'triggeralert', 'createproductionalert', 'installobservability',
      'notifyoperator', 'notifysre', 'notifycustomer', 'notifystakeholder',
      'sendpagerduty', 'sendopsgenie', 'sendslack', 'sendwhatsapp', 'sendemail', 'sendwebhook',
      'grantoperationsaccess', 'modifyrealrbac', 'escalateprivilege', 'openassistedsession',
    ...
    const forceKeys = [
      ...
      'forceExecuteRealRollback', 'forceNotifyRealOperator', 'forceNotifyRealSre',
      'forceNotifyRealCustomer', 'forceNotifyRealStakeholder', 'forceSendWebhook',
      'forceSendSlack', 'forceSendWhatsapp', 'forceSendEmail', 'forceSendPager',
      'forceSendPagerDuty', 'forceSendOpsgenie', 'forceInstallRealObservability',
      'forceCreateProductionAlert', 'forceGrantRealOperationsAccess', 'forceModifyRealRbac',
      'forceEscalateRealPrivilege', 'forceOpenRealAssistedSession', 'forceReadRealTenantData',
      'forceReadRealFiscalDocument', 'forceReadRealXml', 'forceReadRealPdf', 'forceReadRealPfx',
      'forceReadRealCertificate', 'forceReadRealSecret', 'forceExecuteRealOperationsTransition',
      'forceActivateRealOperations', 'forceGrantRealAuthorization', 'forceUnlockRealGate',
      'forceActivateProductionV2', 'forceRouteToV2', 'forceDisableLegacyRoute',
      'forceChangeTraffic', 'forceInstallProxy', 'forceInstallMiddleware', 'forceInstallTap',
      'forceInstallMirror', 'forceInstallSniffer', 'forceEnableShadowTraffic',
      ...
      'forceDispatchRealWorker', 'forceCreateWorker', 'forceCreateScheduler',
      'forceCreateCron', 'forceRunCommandRunner', 'forceExecuteShellCommand',
      'forceConnectRealDatabase', 'forceExecuteDml', 'forceExecuteDdl',
      'forceCallRealSefaz', 'forceLoadRealCertificate', 'forceReadCertificatePassword',
