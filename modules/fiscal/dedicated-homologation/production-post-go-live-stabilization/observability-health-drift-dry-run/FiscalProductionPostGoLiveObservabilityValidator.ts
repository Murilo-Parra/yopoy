...
export class FiscalProductionPostGoLiveObservabilityValidator {
  public static validate(input: FiscalProductionPostGoLiveObservabilityInput): string[] {
    const errors: string[] = [];
    if (input.forceInstallRealObservability) errors.push('forceInstallRealObservability is not allowed');
    if (input.forceConnectPrometheus) errors.push('forceConnectPrometheus is not allowed');
    if (input.forceConnectGrafana) errors.push('forceConnectGrafana is not allowed');
    if (input.forceConnectDatadog) errors.push('forceConnectDatadog is not allowed');
    if (input.forceConnectNewRelic) errors.push('forceConnectNewRelic is not allowed');
    ...
    if (input.forceEvaluateRealSloSla) errors.push('forceEvaluateRealSloSla is not allowed');
    if (input.forcePersistRealMetrics) errors.push('forcePersistRealMetrics is not allowed');
