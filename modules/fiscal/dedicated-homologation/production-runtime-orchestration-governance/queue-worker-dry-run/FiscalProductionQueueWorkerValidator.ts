...
export class FiscalProductionQueueWorkerValidator {
  public static validate(input: FiscalProductionQueueWorkerInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceActivateRealRetry) errors.push('forceActivateRealRetry is not allowed');
    if (input.forceCreateRealDeadLetterQueue) errors.push('forceCreateRealDeadLetterQueue is not allowed');
    if (input.forceStartRealConsumer) errors.push('forceStartRealConsumer is not allowed');
    if (input.forceStartRealProducer) errors.push('forceStartRealProducer is not allowed');
    if (input.forceOpenRealConcurrencyPool) errors.push('forceOpenRealConcurrencyPool is not allowed');
    if (input.forceProcessRealPayload) errors.push('forceProcessRealPayload is not allowed');
