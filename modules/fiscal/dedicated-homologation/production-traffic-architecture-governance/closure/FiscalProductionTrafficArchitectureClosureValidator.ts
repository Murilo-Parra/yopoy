...
export class FiscalProductionTrafficArchitectureClosureValidator {
  public static validate(input: FiscalProductionTrafficArchitectureClosureInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forcePromoteRealRoute) errors.push('forcePromoteRealRoute is not allowed');
    if (input.forceChangeRealTrafficPercentage) errors.push('forceChangeRealTrafficPercentage is not allowed');
    if (input.forceActivateRealCanaryRouting) errors.push('forceActivateRealCanaryRouting is not allowed');
    ...
    if (input.forceDuplicateRealRequest) errors.push('forceDuplicateRealRequest is not allowed');
    if (input.forceMirrorRealTraffic) errors.push('forceMirrorRealTraffic is not allowed');
