import { FiscalRouteSandboxInput } from './FiscalRouteSandboxTypes';

export class FiscalRouteSandboxValidator {
  public static validate(input: FiscalRouteSandboxInput) {
    ...
    const forceKeys = [
      ...
      'forceProvisionDatabase', 'forceCreateTenantIsolation', 'forceCallRealEndpoint',
      ...
      'forceMirrorRealTraffic', 'forceEnableShadowTraffic', 'forceExecuteRealCutover',
      'forceRouteToV2', 'forceDisableLegacyRoute', 'forceChangeTraffic',
      'forceInstallProxy', 'forceInstallMiddleware', 'forceInstallTap',
      'forceModifyAppUse', 'forceModifyRouterUse', 'forceActivateProductionV2',
