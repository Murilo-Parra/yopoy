import { FiscalProductionRuntimeExecutionClosureInput } from './FiscalProductionRuntimeExecutionClosureTypes';

export class FiscalProductionRuntimeExecutionClosureValidator {
  public static validate(input: FiscalProductionRuntimeExecutionClosureInput) {
    ...
    const kwToBlock = [
      ...
      'runtimeclosure', 'executionclosure'
    ];

    for (const kw of kwToBlock) {
       if (lowerJson.includes(kw)) {
          if (!lowerJson.includes('closure') && !lowerJson.includes('evidence') && !lowerJson.includes('handoff') && !lowerJson.includes('inventory') && !lowerJson.includes('checklist') && !lowerJson.includes('roadmap')) {
