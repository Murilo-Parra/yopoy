...
export class FiscalProductionFinalStateIntegrityValidator {
  public static validate(input: FiscalProductionFinalStateIntegrityInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forcePersistRealConsistencyResult) errors.push('forcePersistRealConsistencyResult is not allowed');
    ...
    if (input.forceGenerateRealDigest) errors.push('forceGenerateRealDigest is not allowed');
    if (input.forceGenerateRealChecksum) errors.push('forceGenerateRealChecksum is not allowed');
    if (input.forceGenerateRealHash) errors.push('forceGenerateRealHash is not allowed');
    if (input.forceVerifyRealSignature) errors.push('forceVerifyRealSignature is not allowed');
    if (input.forceGenerateRealSignature) errors.push('forceGenerateRealSignature is not allowed');
    if (input.forceCreateMerkleTree) errors.push('forceCreateMerkleTree is not allowed');
    if (input.forceCreateMerkleProof) errors.push('forceCreateMerkleProof is not allowed');
