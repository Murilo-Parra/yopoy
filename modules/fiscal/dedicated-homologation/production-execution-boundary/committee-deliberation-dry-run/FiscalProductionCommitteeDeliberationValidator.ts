import { FiscalProductionCommitteeDeliberationInput } from './FiscalProductionCommitteeDeliberationTypes';

export class FiscalProductionCommitteeDeliberationValidator {
  public static validate(input: FiscalProductionCommitteeDeliberationInput) {
    ...
    const forceKeys = [
      ...
      'forceNotifyExternalStakeholder', 'forceGrantRealAuthorization', 'forceUnlockRealGate',
