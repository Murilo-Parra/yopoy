import { FiscalDay2OperationsInput } from './FiscalDay2OperationsTypes';

export class FiscalDay2OperationsValidator {
  public static validate(input: FiscalDay2OperationsInput) {
    ...
    const kwToBlock = [
      ...
      'escalation', 'notify', 'slack', 'whatsapp', 'email', 'webhook',
    ...
    const forceKeys = [
      'forceExecuteRealDay2Operation', 'forceExecuteRealRunbook', 'forceOpenRealIncident', 'forceCreateProductionAlert',
      'forceInstallRealObservability', 'forceNotifyExternalOperator', 'forceSendSlack', 'forceSendWhatsapp',
      'forceSendEmail', 'forceSendWebhook', 'forceActivateProductionV2', 'forceChangeTraffic', 'forceRouteToV2',
