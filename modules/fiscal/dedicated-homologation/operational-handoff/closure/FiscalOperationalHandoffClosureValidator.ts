import { FiscalOperationalHandoffClosureInput } from './FiscalOperationalHandoffClosureTypes';

export class FiscalOperationalHandoffClosureValidator {
  public static validate(input: FiscalOperationalHandoffClosureInput) {
