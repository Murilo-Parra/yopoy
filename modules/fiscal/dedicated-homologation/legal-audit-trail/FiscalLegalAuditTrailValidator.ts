import { FiscalLegalAuditTrailInput } from './FiscalLegalAuditTrailTypes';

export class FiscalLegalAuditTrailValidator {
  public static validate(input: FiscalLegalAuditTrailInput) {
