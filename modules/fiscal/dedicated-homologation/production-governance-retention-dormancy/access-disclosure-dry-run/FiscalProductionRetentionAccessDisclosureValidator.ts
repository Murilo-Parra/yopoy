...
export class FiscalProductionRetentionAccessDisclosureValidator {
  public static validate(input: FiscalProductionRetentionAccessDisclosureInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceReadRealRetentionRecord) errors.push('forceReadRealRetentionRecord is not allowed');
    if (input.forceReadRealCustodyRecord) errors.push('forceReadRealCustodyRecord is not allowed');
    if (input.forceReadRealDisclosureRecord) errors.push('forceReadRealDisclosureRecord is not allowed');
    ...
    if (input.forceApplyRealRedaction) errors.push('forceApplyRealRedaction is not allowed');
    if (input.forcePersistRealAccessAudit) errors.push('forcePersistRealAccessAudit is not allowed');
    if (input.forcePersistRealDisclosureRecord) errors.push('forcePersistRealDisclosureRecord is not allowed');
    if (input.forcePersistRealExportRecord) errors.push('forcePersistRealExportRecord is not allowed');
