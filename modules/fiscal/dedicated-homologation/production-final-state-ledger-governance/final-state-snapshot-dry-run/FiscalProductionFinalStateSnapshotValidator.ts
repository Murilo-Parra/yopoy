...
export class FiscalProductionFinalStateSnapshotValidator {
  public static validate(input: FiscalProductionFinalStateSnapshotInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceCreateLegalProof) errors.push('forceCreateLegalProof is not allowed');
