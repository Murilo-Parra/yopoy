...
export class FiscalProductionCorporateGovernanceArchiveValidator {
  public static validate(input: FiscalProductionCorporateGovernanceArchiveInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceGenerateRealArchiveFile) errors.push('forceGenerateRealArchiveFile is not allowed');
