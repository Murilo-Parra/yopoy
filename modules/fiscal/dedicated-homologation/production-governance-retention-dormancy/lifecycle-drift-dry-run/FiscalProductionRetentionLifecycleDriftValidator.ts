...
export class FiscalProductionRetentionLifecycleDriftValidator {
  public static validate(input: FiscalProductionRetentionLifecycleDriftInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceApplyRealPolicyVersion) errors.push('forceApplyRealPolicyVersion is not allowed');
    ...
    if (input.forcePersistRealLifecycleRecord) errors.push('forcePersistRealLifecycleRecord is not allowed');
    ...
    if (input.forcePersistRealCustodyDriftRecord) errors.push('forcePersistRealCustodyDriftRecord is not allowed');
    ...
    if (input.forceExportRealLifecyclePackage) errors.push('forceExportRealLifecyclePackage is not allowed');
    if (input.forceSendRealLifecyclePackage) errors.push('forceSendRealLifecyclePackage is not allowed');
