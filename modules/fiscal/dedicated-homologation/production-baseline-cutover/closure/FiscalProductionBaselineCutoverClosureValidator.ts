import { FiscalProductionBaselineCutoverClosureInput } from './FiscalProductionBaselineCutoverClosureTypes';

export class FiscalProductionBaselineCutoverClosureValidator {
  public static validate(input: FiscalProductionBaselineCutoverClosureInput) {
    ...
    const kwToBlock = [
      ...
      'closeasrealcutover', 'realclosure', 'executerealclosure', 'executerealrollback', 'executerealabort', 'revertrealtraffic', 'restorelegacybyruntime',
      'rollbacktraffic', 'rollbackroute', 'rollbackcutover', 'abortcutover', 'recoveryruntime',
    ...
    const forceKeys = [
      'forceCloseAsRealCutover', 'forceGrantRealAuthorization', 'forceUnlockRealGate',
      'forceExecuteRealCutover', 'forceExecuteRealGoLive', 'forceExecuteRealRollback',
      'forceExecuteRealAbort', 'forceRevertRealTraffic', 'forceOrchestrateRealCutover',
      'forceExecuteRealEndpointRollout', 'forcePromoteRealRoute', 'forceApproveRealCutover',
      ...
      'forceCallV2Handler', 'forceExecuteRealDeploy', 'forceExecuteRealRelease',
