import { FiscalRealCommandManifestInput, FiscalRealCommandManifestStatus, FiscalRealCommandManifestResult } from './FiscalRealCommandManifestTypes';
import { FiscalRealCommandManifestValidator } from './FiscalRealCommandManifestValidator';

export class FiscalRealCommandManifestPolicy {
  public static enforce(input: FiscalRealCommandManifestInput): Partial<FiscalRealCommandManifestResult> | null {
    ...
    if (blockers.length > 1 || validation.blockers.length > 0) {
      ...
      return {
        ...baseResult,
        success: false,
        status: FiscalRealCommandManifestStatus.BLOCKED_FOR_REAL_EXECUTION,
  ...
  public static getBaseResult(): FiscalRealCommandManifestResult {
    return {
        success: true,
        status: FiscalRealCommandManifestStatus.COMMAND_MANIFEST_READY,
