...
export class FiscalProductionGoLiveRollbackValidator {
  public static validate(input: FiscalProductionGoLiveRollbackInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceExecuteRealDeploy) errors.push('forceExecuteRealDeploy is not allowed');
