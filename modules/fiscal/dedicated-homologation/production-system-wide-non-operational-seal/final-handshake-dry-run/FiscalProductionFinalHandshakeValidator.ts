...
export class FiscalProductionFinalHandshakeValidator {
  public static validate(input: FiscalProductionFinalHandshakeInput): string[] {
    const errors: string[] = [];
    if (input.forceExecuteRealHandshake) errors.push('forceExecuteRealHandshake is not allowed');
    if (input.forceConcludeRealSignOff) errors.push('forceConcludeRealSignOff is not allowed');
    if (input.forceCollectRealSignature) errors.push('forceCollectRealSignature is not allowed');
    if (input.forceConvertSignOffToAuthority) errors.push('forceConvertSignOffToAuthority is not allowed');
    if (input.forceConvertEvidenceToAuthority) errors.push('forceConvertEvidenceToAuthority is not allowed');
    ...
    if (input.forceExportRealPackage) errors.push('forceExportRealPackage is not allowed');
    if (input.forceSendRealPackage) errors.push('forceSendRealPackage is not allowed');
    ...
    if (input.forceExecuteRealFinalCommand) errors.push('forceExecuteRealFinalCommand is not allowed');
