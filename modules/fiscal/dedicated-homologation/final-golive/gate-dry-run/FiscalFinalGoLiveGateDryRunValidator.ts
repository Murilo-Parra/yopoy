import { FiscalFinalGoLiveGateDryRunInput } from './FiscalFinalGoLiveGateDryRunTypes';

export class FiscalFinalGoLiveGateDryRunValidator {
  public static validate(input: FiscalFinalGoLiveGateDryRunInput) {
    ...
    const forceKeys = [
      ...
      'forceExecuteRealRunbook', 'forceModifyAppUse', 'forceInstallMiddleware',
      'forceInstallTap', 'forceCreateWorker', 'forceCreateScheduler',
      'forceUnlockGate', 'forceGrantRealAuthorization', 'forceGrantLegalSignOff',
      'forcePersistLegalSignature', 'forceCreateDefinitiveLegalRecord', 'forceAcceptRealRisk',
      'forceGrantRealWaiver', 'forceNotifyExternalApprover', 'forceNotifyExternalSigner',
