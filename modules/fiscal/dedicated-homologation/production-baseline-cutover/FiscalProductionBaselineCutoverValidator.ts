import { FiscalProductionBaselineCutoverInput } from './FiscalProductionBaselineCutoverTypes';

export class FiscalProductionBaselineCutoverValidator {
  public static validate(input: FiscalProductionBaselineCutoverInput) {
    ...
    const kwToBlock = [
      ...
      'executebaselinecutover', 'realcutover', 'hardunlock', 'grantauthorization', 'unlockgate', 'changetraffic',
      'promotetraffic', 'switchtraffic', 'routetov2', 'disablelegacy', 'reroute', 'finalrouteswitch',
      'activatev2', 'activateproduction', 'golive', 'reversiblegolive', 'deploy', 'releaseproduction',
      'cutover', 'rollback', 'canary', 'rollout', 'installproxy', 'installmiddleware', 'installtap',
      'installmirror', 'installsniffer', 'mirrortraffic', 'shadowtraffic', 'duplicaterequest', 'capturerequest',
    ...
    const forceKeys = [
      'forceExecuteRealCutover', 'forceExecuteRealGoLive', 'forceGrantRealAuthorization', 'forceUnlockRealGate',
