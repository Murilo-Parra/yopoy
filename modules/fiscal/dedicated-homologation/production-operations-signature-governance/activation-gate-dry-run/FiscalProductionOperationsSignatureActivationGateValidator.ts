export class FiscalProductionOperationsSignatureActivationGateValidator {
  public static validate(input: any) {
    ...
    const blockedKeywords = [
      ...
      'res.send', 'res.json', 'unlockRealGate', 'issueRealAuthorizationToken', 'grantAuthorization',
      'hardUnlock', 'changeTraffic', 'routeToV2', 'disableLegacy', 'activateV2', 'activateProduction',
      'goLive', 'deploy', 'releaseProduction', 'cutover', 'rollback', 'canary', 'rollout',
      'grantRealSignature', 'collectRealSignature', 'collectRealCryptographicSignature',
      'persistRealConsent', 'persistRealSignatureRecord', 'persistRealApprovalRecord', 'signXml',
      'generatePdf', 'cryptoSign', 'readPfx', 'readCertificate', 'readSecret', 'readCertificatePassword',
      ...
      // Force flags
      'forceUnlockRealGate', 'forceGrantRealAuthorization', 'forceIssueRealAuthorizationToken',
      ...
      'forcePersistRealConsent', 'forcePersistRealSignatureRecord', 'forcePersistRealApprovalRecord',
      'forceReadRealCertificate', 'forceReadRealPfx', 'forceReadCertificatePassword', 'forceReadRealSecret',
      'forceReadPrivateKey', 'forceReadToken', 'forceUseRealCrypto', 'forceSignRealXml',
      'forceGenerateRealPdf', 'forceNotifyRealStakeholder', 'forceNotifyRealSigner',
      'forceNotifyRealApprover', 'forceSendWebhook', 'forceSendSlack', 'forceSendWhatsapp',
      'forceSendEmail', 'forceSendPager', 'forceSendPagerDuty', 'forceSendOpsgenie',
      ...
      'forceRunCommandRunner', 'forceExecuteShellCommand', 'forceExecuteRealOperationsTransition',
      'forceActivateRealOperations', 'forceCompleteRealOperationsHandoff'
    ];
