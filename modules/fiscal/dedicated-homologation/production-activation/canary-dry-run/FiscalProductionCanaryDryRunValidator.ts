import { FiscalProductionCanaryDryRunInput } from './FiscalProductionCanaryDryRunTypes';

export class FiscalProductionCanaryDryRunValidator {
  public static validate(input: FiscalProductionCanaryDryRunInput) {
