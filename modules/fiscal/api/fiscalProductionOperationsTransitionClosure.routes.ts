...
import { FiscalProductionOperationsTransitionClosureController } from './FiscalProductionOperationsTransitionClosureController';
import { requireFiscalAuth } from './helpers';

const router = Router();
const controller = new FiscalProductionOperationsTransitionClosureController();
