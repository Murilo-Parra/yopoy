...
export class FiscalProductionDatabasePersistenceValidator {
  public static validate(input: FiscalProductionDatabasePersistenceInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceExecuteRealQueryRunner) errors.push('forceExecuteRealQueryRunner is not allowed');
    ...
    if (input.forceCreateRealSchema) errors.push('forceCreateRealSchema is not allowed');
    if (input.forceAlterRealTable) errors.push('forceAlterRealTable is not allowed');
    ...
    if (input.forceReadDatabasePassword) errors.push('forceReadDatabasePassword is not allowed');
