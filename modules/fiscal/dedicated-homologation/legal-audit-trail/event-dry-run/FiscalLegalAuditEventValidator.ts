import { FiscalLegalAuditEventDryRunInput } from './FiscalLegalAuditEventDryRunTypes';

export class FiscalLegalAuditEventValidator {
  public static validate(input: FiscalLegalAuditEventDryRunInput) {
