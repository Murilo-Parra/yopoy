...
export class FiscalProductionCrossDomainSealEvidenceValidator {
  public static validate(input: FiscalProductionCrossDomainSealEvidenceInput): string[] {
    const errors: string[] = [];
    if (input.forceCreateRealSeal) errors.push('forceCreateRealSeal is not allowed');
    if (input.forceRevalidateRealAuthority) errors.push('forceRevalidateRealAuthority is not allowed');
    ...
    if (input.forceExportRealEvidencePackage) errors.push('forceExportRealEvidencePackage is not allowed');
    if (input.forceSendRealEvidencePackage) errors.push('forceSendRealEvidencePackage is not allowed');
