import { FiscalLegalSignOffClosureInput } from './FiscalLegalSignOffClosureTypes';

export class FiscalLegalSignOffClosureValidator {
  public static validate(input: FiscalLegalSignOffClosureInput) {
    ...
    const forceKeys = [
      ...
      'forceGenerateRealPdf','forceExecuteRunbook', 'forceActivateProductionV2', 'forceChangeTraffic', 
      'forceModifyAppUse', 'forceInstallMiddleware', 'forceInstallTap', 'forceCreateWorker', 
