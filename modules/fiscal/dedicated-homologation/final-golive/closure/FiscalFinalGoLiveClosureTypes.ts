export enum FiscalFinalGoLiveClosureStatus {
  FINAL_GOLIVE_GOVERNANCE_CLOSURE_READY = 'FINAL_GOLIVE_GOVERNANCE_CLOSURE_READY',
  NO_ACTIVATION_HANDOFF_EVIDENCE_READY = 'NO_ACTIVATION_HANDOFF_EVIDENCE_READY',
  BLOCKED_FOR_REAL_PRODUCTION_ACTIVATION = 'BLOCKED_FOR_REAL_PRODUCTION_ACTIVATION',
  FAILED_SAFE = 'FAILED_SAFE'
}

export interface FiscalFinalGoLiveClosureInput {
  requestedBy?: string;
  companyId?: string;
  requestId?: string;
...
export interface FiscalFinalGoLiveClosureResult {
  success: boolean;
  status: FiscalFinalGoLiveClosureStatus | string;
