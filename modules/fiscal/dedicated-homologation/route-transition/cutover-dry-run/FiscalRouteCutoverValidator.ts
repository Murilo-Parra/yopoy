import { FiscalRouteCutoverInput } from './FiscalRouteCutoverDryRunTypes';

export class FiscalRouteCutoverValidator {
  public static validate(input: FiscalRouteCutoverInput) {
    ...
    const forceKeys = [
      ...
      'forceChangeTraffic', 'forceActivateCanary', 'forceExecuteShadowRollback',
      'forceExecuteRealFallback', 'forceInstallProxy', 'forceInstallMiddleware',
      'forceInstallTap', 'forceModifyAppUse', 'forceModifyRouterUse',
      'forceDuplicateRequest', 'forceCaptureResponse', 'forceCapturePayload',
      'forceCallV2Handler', 'forceCallLegacyHandler', 'forceActivateProductionV2',
