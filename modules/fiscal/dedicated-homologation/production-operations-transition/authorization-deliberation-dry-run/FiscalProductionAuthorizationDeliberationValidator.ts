import { FiscalProductionAuthorizationDeliberationInput } from './FiscalProductionAuthorizationDeliberationTypes';

export class FiscalProductionAuthorizationDeliberationValidator {
  public static validate(input: FiscalProductionAuthorizationDeliberationInput) {
    ...
    const kwToBlock = [
      ...
      'grantauthorization', 'unlockgate', 'realdeliberation', 'persistdeliberation', 'convertconsenttoauthorization',
      'collectsignature', 'digitalsignature', 'twopersonapproval', 'acceptrisk', 'grantwaiver', 'approvernotification',
      ...
      'dbtransaction', 'sefazcall', 'signxml', 'generatepdf', 'cryptosign', 'productionexecution', 'executeproduction'
    ];
    ...
    const forceKeys = [
      'forceGrantRealAuthorization', 'forceUnlockRealGate', 'forceCompleteRealDeliberation', 'forcePersistRealDeliberation',
      'forceConvertDryRunConsentToRealAuthorization', 'forceCollectRealSignature', 'forceCompleteRealTwoPersonApproval',
      'forceAcceptRealRisk', 'forceGrantRealWaiver', 'forceNotifyRealApprover', 'forceSendWebhook', 'forceSendSlack',
