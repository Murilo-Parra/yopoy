import { FiscalRouteTransitionInput } from './FiscalRouteTransitionTypes';

export class FiscalRouteTransitionValidator {
  public static validate(input: FiscalRouteTransitionInput) {
    ...
    const forceKeys = [
      ...
      'forceModifyAppUse', 'forceInstallMiddleware', 'forceInstallProxy',
      'forceInstallTap', 'forceCallV2Handler', 'forceCallLegacyHandler',
