export enum FiscalProductionExecutionAuthorizationClosureStatus {
  PRODUCTION_EXECUTION_AUTHORIZATION_CLOSURE_READY = 'PRODUCTION_EXECUTION_AUTHORIZATION_CLOSURE_READY',
  NO_EXECUTION_FINAL_HANDOFF_READY = 'NO_EXECUTION_FINAL_HANDOFF_READY',
...
export interface FiscalProductionExecutionAuthorizationClosureInput {
  requestedBy?: string;
  companyId?: string;
  requestId?: string;
...
export interface FiscalProductionExecutionAuthorizationClosureResult {
  success: boolean;
  status: FiscalProductionExecutionAuthorizationClosureStatus | string;
