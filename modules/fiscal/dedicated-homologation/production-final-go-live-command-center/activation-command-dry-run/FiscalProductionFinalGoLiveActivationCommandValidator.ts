...
export class FiscalProductionFinalGoLiveActivationCommandValidator {
  public static validate(input: FiscalProductionFinalGoLiveActivationCommandInput): string[] {
    const errors: string[] = [];
