import { FiscalFinalGoLiveClosureInput } from './FiscalFinalGoLiveClosureTypes';

export class FiscalFinalGoLiveClosureValidator {
  public static validate(input: FiscalFinalGoLiveClosureInput) {
