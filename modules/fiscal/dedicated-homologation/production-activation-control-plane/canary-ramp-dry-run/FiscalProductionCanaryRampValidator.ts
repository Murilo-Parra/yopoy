export class FiscalProductionCanaryRampValidator {
  public static validate(input: any) {
    ...
    const blockedKeywords = [
      ...
      'res.send', 'res.json', 'activateRealCanary', 'promoteRealTraffic', 'changeTraffic', 'trafficSlice',
      'routeToV2', 'disableLegacy', 'activateV2', 'activateProduction', 'goLive', 'deploy',
      'releaseProduction', 'cutover', 'rollback', 'canary', 'rollout', 'unlockRealGate', 'grantAuthorization',
      'issueRealAuthorizationToken', 'installProxy', 'installMiddleware', 'installTap', 'installMirror',
      'installSniffer', 'captureRequest', 'captureResponse', 'capturePayload', 'duplicateRequest',
      'mirrorTraffic', 'shadowTraffic', 'startRuntimeExecution', 'startCommandQueue', 'enqueueRealJob',
      'dispatchRealWorker', 'createWorker', 'createScheduler', 'createCron', 'shellCommand', 'commandRunner',
