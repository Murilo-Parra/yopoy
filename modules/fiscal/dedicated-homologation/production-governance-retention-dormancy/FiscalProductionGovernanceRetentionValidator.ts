...
export class FiscalProductionGovernanceRetentionValidator {
  public static validate(input: FiscalProductionGovernanceRetentionInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceGenerateRealRetentionRecord) errors.push('forceGenerateRealRetentionRecord is not allowed');
    if (input.forceGenerateRealCustodyRecord) errors.push('forceGenerateRealCustodyRecord is not allowed');
    ...
    if (input.forceExportRealRetentionPackage) errors.push('forceExportRealRetentionPackage is not allowed');
    if (input.forceSendRealRetentionPackage) errors.push('forceSendRealRetentionPackage is not allowed');
