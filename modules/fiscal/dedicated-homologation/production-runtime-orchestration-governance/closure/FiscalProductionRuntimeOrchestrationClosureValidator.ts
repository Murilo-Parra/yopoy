...
export class FiscalProductionRuntimeOrchestrationClosureValidator {
  public static validate(input: FiscalProductionRuntimeOrchestrationClosureInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forcePublishRealPackage) errors.push('forcePublishRealPackage is not allowed');
    if (input.forceGenerateExecutableArtifact) errors.push('forceGenerateExecutableArtifact is not allowed');
