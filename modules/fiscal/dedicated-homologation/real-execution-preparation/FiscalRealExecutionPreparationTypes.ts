export enum FiscalRealExecutionPreparationStatus {
  EXECUTION_PREPARATION_READY = 'EXECUTION_PREPARATION_READY',
  OPERATIONAL_ENVELOPE_READY = 'OPERATIONAL_ENVELOPE_READY',
  BLOCKED_FOR_REAL_EXECUTION = 'BLOCKED_FOR_REAL_EXECUTION',
  FAILED_SAFE = 'FAILED_SAFE'
}

export enum FiscalRealExecutionPreparationDomain {
...
export interface FiscalRealExecutionPreparationInput {
  requestedBy?: string;
  companyId?: string;
...
export interface FiscalRealExecutionPreparationResult {
  success: boolean;
  status: FiscalRealExecutionPreparationStatus | string;
  evaluationExecuted: boolean;
  preparationSimulated: boolean;
  operationalEnvelopeGenerated: boolean;
  go: boolean;
  noGo: boolean;
  blockers: string[];
  warnings: string[];
...
export interface FiscalRealExecutionPreparationReport {
  generatedAt: string;
  status: FiscalRealExecutionPreparationStatus | string;
  operationalEnvelope: any;
  checklist: any;
  blockers: any;
  risks: any;
  evaluation: any;
