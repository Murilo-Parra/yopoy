...
export class FiscalProductionPostGoLiveRemediationValidator {
  public static validate(input: FiscalProductionPostGoLiveRemediationInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceAuthorizeRealStabilizationDecision) errors.push('forceAuthorizeRealStabilizationDecision is not allowed');
    ...
    if (input.forceReadRealTelemetry) errors.push('forceReadRealTelemetry is not allowed');
