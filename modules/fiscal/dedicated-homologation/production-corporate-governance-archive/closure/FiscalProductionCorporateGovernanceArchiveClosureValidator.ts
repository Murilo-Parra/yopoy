...
export class FiscalProductionCorporateGovernanceArchiveClosureValidator {
  public static validate(input: FiscalProductionCorporateGovernanceArchiveClosureInput): string[] {
    const errors: string[] = [];
    ...
    if (input.forceCreateRealArchive) errors.push('forceCreateRealArchive is not allowed');
    if (input.forceCreateRealCorporateRecord) errors.push('forceCreateRealCorporateRecord is not allowed');
    if (input.forceConcludeRealBoardReview) errors.push('forceConcludeRealBoardReview is not allowed');
    if (input.forceCollectRealExecutiveAcknowledgement) errors.push('forceCollectRealExecutiveAcknowledgement is not allowed');
    if (input.forceCreateRealBoardApproval) errors.push('forceCreateRealBoardApproval is not allowed');
    if (input.forceCreateRealBoardMinutes) errors.push('forceCreateRealBoardMinutes is not allowed');
    if (input.forceGenerateRealMeetingRecord) errors.push('forceGenerateRealMeetingRecord is not allowed');
    ...
    if (input.forcePersistRealArchiveRecord) errors.push('forcePersistRealArchiveRecord is not allowed');
    if (input.forcePersistRealContinuityRecord) errors.push('forcePersistRealContinuityRecord is not allowed');
    if (input.forcePersistRealBoardRecord) errors.push('forcePersistRealBoardRecord is not allowed');
    if (input.forcePersistRealAcknowledgementRecord) errors.push('forcePersistRealAcknowledgementRecord is not allowed');
    if (input.forceExportRealArchive) errors.push('forceExportRealArchive is not allowed');
    if (input.forceExportRealBoardPackage) errors.push('forceExportRealBoardPackage is not allowed');
    if (input.forceSendRealArchivePackage) errors.push('forceSendRealArchivePackage is not allowed');
    if (input.forceSendRealBoardPackage) errors.push('forceSendRealBoardPackage is not allowed');
