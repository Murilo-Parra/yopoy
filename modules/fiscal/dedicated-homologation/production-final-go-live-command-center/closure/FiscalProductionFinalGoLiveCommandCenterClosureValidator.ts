...
export class FiscalProductionFinalGoLiveCommandCenterClosureValidator {
  public static validate(input: FiscalProductionFinalGoLiveCommandCenterClosureInput): string[] {
    const errors: string[] = [];
