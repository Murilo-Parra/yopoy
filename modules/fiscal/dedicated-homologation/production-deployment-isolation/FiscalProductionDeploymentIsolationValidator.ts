import { FiscalProductionDeploymentIsolationInput } from './FiscalProductionDeploymentIsolationTypes';

export class FiscalProductionDeploymentIsolationValidator {
  public static validate(input: FiscalProductionDeploymentIsolationInput) {
    ...
    const forceKeys = [
      ...
      'forceExecuteRealRollout', 'forceActivateCanary', 'forceExecuteRealCutover',
      ...
      'forceCaptureResponse', 'forceCapturePayload', 'forceDuplicateRequest',
      'forceMirrorRealTraffic', 'forceEnableShadowTraffic', 'forceCreateRealSandbox',
      'forceCreateWalledGarden', 'forceProvisionNetwork', 'forceProvisionDatabase',
      'forceCreateTenantIsolation', 'forceCreateWorker', 'forceCreateScheduler',
