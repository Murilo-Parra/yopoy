import { FiscalProductionBaselineApprovalInput } from './FiscalProductionBaselineApprovalTypes';

export class FiscalProductionBaselineApprovalValidator {
  public static validate(input: FiscalProductionBaselineApprovalInput) {
    ...
    const kwToBlock = [
      ...
      'approverealcutover', 'approvebaselinecutover', 'executebaselinecutover', 'realcutover', 'hardunlock', 
    ...
    const forceKeys = [
      'forceApproveRealCutover', 'forceExecuteRealCutover', 'forceExecuteRealGoLive', 'forceGrantRealAuthorization', 'forceUnlockRealGate',
