import { FiscalSyntheticRouteDryRunInput } from './FiscalSyntheticRouteDryRunTypes';

export class FiscalSyntheticRouteDryRunValidator {
  public static validate(input: FiscalSyntheticRouteDryRunInput) {
    ...
    const forceKeys = [
      ...
      'forceDuplicateRequest', 'forceMirrorRealTraffic', 'forceEnableShadowTraffic',
      'forceExecuteRealCutover', 'forceRouteToV2', 'forceDisableLegacyRoute',
      'forceChangeTraffic', 'forceActivateCanary', 'forceExecuteRealFallback',
