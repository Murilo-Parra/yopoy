export enum FiscalProductionExecutionOrchestrationStatus {
  PRODUCTION_EXECUTION_ORCHESTRATION_BLUEPRINT_READY = 'PRODUCTION_EXECUTION_ORCHESTRATION_BLUEPRINT_READY',
  RUNTIME_NO_OP_SAFETY_CONTRACT_READY = 'RUNTIME_NO_OP_SAFETY_CONTRACT_READY',
  COMMAND_BOUNDARY_PLAN_READY = 'COMMAND_BOUNDARY_PLAN_READY',
  BLOCKED_FOR_REAL_PRODUCTION_EXECUTION = 'BLOCKED_FOR_REAL_PRODUCTION_EXECUTION',
  FAILED_SAFE = 'FAILED_SAFE'
}

export interface FiscalProductionExecutionOrchestrationInput {
  requestedBy?: string;
  companyId?: string;
  requestId?: string;
...
export interface FiscalProductionExecutionOrchestrationResult {
  success: boolean;
  status: FiscalProductionExecutionOrchestrationStatus | string;
  validationExecuted: boolean;
  evaluationExecuted: boolean;
  decisionSimulated: boolean;
  orchestrationBlueprintGenerated: boolean;
  runtimeNoOpSafetyContractGenerated: boolean;
  runtimePlanGenerated: boolean;
  commandBoundaryPlanGenerated: boolean;
  guardrailMatrixGenerated: boolean;
  preRunChecklistGenerated: boolean;
