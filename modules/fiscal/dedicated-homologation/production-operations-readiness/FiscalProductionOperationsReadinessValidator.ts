import { FiscalProductionOperationsReadinessInput } from './FiscalProductionOperationsReadinessTypes';

export class FiscalProductionOperationsReadinessValidator {
  public static validate(input: FiscalProductionOperationsReadinessInput) {
    ...
    const kwToBlock = [
      ...
      'executerealoperationstransition', 'activaterealoperations', 'realoperationsactivation', 'operationsgolive', 'transitiontooperations', 'hardunlock', 
    ...
    const forceKeys = [
      'forceExecuteRealOperationsTransition', 'forceActivateRealOperations', 'forceGrantRealAuthorization',
      'forceUnlockRealGate', 'forceExecuteRealCutover', 'forceExecuteRealGoLive', 'forceExecuteRealRollback',
