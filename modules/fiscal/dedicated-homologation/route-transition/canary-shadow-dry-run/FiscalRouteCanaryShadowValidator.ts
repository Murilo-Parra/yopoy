import { FiscalRouteCanaryShadowInput } from './FiscalRouteCanaryShadowDryRunTypes';

export class FiscalRouteCanaryShadowValidator {
  public static validate(input: FiscalRouteCanaryShadowInput) {
    ...
    const forceKeys = [
      'forceActivateCanary', 'forceEnableShadowTraffic', 'forceMirrorRealTraffic',
      'forceDuplicateRequest', 'forceCaptureResponse', 'forceCapturePayload',
      'forceCallV2Handler', 'forceCallLegacyHandler', 'forceInstallProxy',
      'forceInstallMiddleware', 'forceInstallTap', 'forceModifyAppUse',
      'forceModifyRouterUse', 'forceRouteToV2', 'forceDisableLegacyRoute',
      'forceChangeTraffic', 'forceActivateProductionV2', 'forceActivateRelease',
