export class FiscalProductionEvidenceIntakeValidator {
  public static validate(input: any) {
    ...
    const blockedKeywords = [
      ...
      'req.rawBody', 'res.send', 'res.json', 'persistRealEvidence', 'persistRealAuditRecord',
      'readRealPayload', 'readRealXml', 'readRealPdf', 'readRealPfx', 'readRealCertificate',
      'readCertificatePassword', 'readRealSecret', 'readPrivateKey', 'readToken', 'writeFileSystem',
      'writeDatabase', 'uploadExternalStorage', 'exportRealEvidence', 'useRealCrypto', 'hashRealPayload',
      'verifyRealSourceAuthenticity', 'persistChainOfCustody', 'createRetentionRecord', 'signXml', 'generatePdf',
